        ...
        <div>
            <div className=''>
                <div className='flex justify-center items-center mt-18 drop-shadow-xl/800'>
                    <div className=' w-6/12 mx-auto relative bg-[#56c9c199] rounded-2xl '> 
                    ...
                    <div className='flex flex-col justify-center items-center gap-6'>
                        ...
                        <h1 className='text-gray-600 text-sm sm:text-base  flex justify-center items-center gap-2'><FaRegistered /> There is no page on the path name : { location.pathname}</h1>
